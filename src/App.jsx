...
import { BookOpen, CalendarDays, ClipboardCheck, Cloud, CloudOff, Database, Megaphone, Moon, Settings, Sun } from 'lucide-react'
...
const TABS = [
  ...
  { id: 'schedule', label: 'Jadwal', icon: BookOpen, View: ScheduleView },
...
function Shell() {
  ...
  const Active = TABS.find((t) => t.id === tab)?.View || TasksView
  ...
  return (
    <div className="relative z-10 min-h-dvh">
      ...
      {/* navigasi mobile (diubah ke grid-cols-5 agar muat 5 tombol) */}
